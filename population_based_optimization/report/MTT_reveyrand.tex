...
Objects of this class stores its position, its velocity, and its best position. The class provides, ass well, methods to the particle update its velocity and its position.
